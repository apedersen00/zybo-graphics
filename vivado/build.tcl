#
# build.tcl: tcl script for recreating the Vivado project 'zybo-graphics'
#
#*****************************************************************************************
...
# Create project
create_project zybo-graphics $origin_dir/zybo-graphics -part xc7z010clg400-1
...
set obj [get_projects zybo-graphics]
set_property -name "board_part" -value "digilentinc.com:zybo:part0:1.0" -objects $obj
set_property -name "default_lib" -value "xil_defaultlib" -objects $obj
set_property -name "ip_cache_permissions" -value "read write" -objects $obj
set_property -name "ip_output_repo" -value "$proj_dir/zybo-graphics.cache/ip" -objects $obj
...
puts "INFO: Project created:zybo-graphics"
